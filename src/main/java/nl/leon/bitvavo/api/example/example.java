package nl.leon.bitvavo.api.example;

import nl.leon.bitvavo.api.Bitvavo;
import nl.leon.bitvavo.api.WebsocketClientEndpoint;
import org.json.*;
...
class example{
  ...
  public static void testWebsocket(Bitvavo bitvavo) throws JSONException {
